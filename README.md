...
Note that the [hieroglyph set](https://github.com/arsaccol/inpu/blob/main/src/assets/002_hieroglyph_data.sql) is still incomplete, and we are working on expanding it.
